"        ____         ____                           _
"       |  _ \ _   _ / ___|___  _ __   ___ ___  __ _| |
"       | |_) | | | | |   / _ \| '_ \ / __/ _ \/ _` | |
"       |  __/| |_| | |__| (_) | | | | (_|  __/ (_| | |
"       |_|    \__, |\____\___/|_| |_|\___\___|\__,_|_|
"              |___/

nnoremap \\c :let &cole=(&cole == 2)? 0 : 2 <bar> echo 'conceallevel ' . &cole <CR>

syntax match pythonOperator '\%(is \)\@<!\<not\%( \|\>\)' conceal cchar=¬
syntax match pythonOperator '\v<not in>' conceal cchar=∉
syntax match pythonOperator '\v<in>' conceal cchar=∈

" keywords
syntax match pyKeyword '\v<self>' conceal cchar=⚕
...
" Controversial
" Code control
syntax keyword pythonStatement if conceal cchar=▸
syntax keyword pythonStatement elif conceal cchar=▹
syntax keyword pythonStatement else conceal cchar=▪
syntax keyword pythonStatement break conceal cchar=◁
syntax keyword pythonStatement return conceal cchar=◀
syntax keyword pythonStatement for conceal cchar=∀
syntax keyword pythonStatement while conceal cchar=⥁
syntax keyword pythonStatement assert conceal cchar=‽
" class and def
syntax keyword pythonStatement class conceal cchar=※
syntax keyword pythonStatement def conceal cchar=§
syntax keyword pythonKeyword None conceal cchar=∅

hi Conceal ctermfg=172 ctermbg=234

" .............................................................................
"   Code taken from: https://raw.githubusercontent.com/alok/python-conceal/master/after/syntax/python.vim
" .............................................................................
